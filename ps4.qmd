...
The duration for running teh subset is around 0.5 seconds. The approximated entire procedure for full dataset will be around 105 seconds.
...
Referencing https://stackoverflow.com/questions/30740046/calculate-distance-to-nearest-feature-with-geopandas for calculating distance, searching distance to centroid
    ...
    c.
```{python}
with open("/Users/kongzidan/Documents/GitHub/problem-set-4-boya-zidan/gz_2010_us_860_00_500k/gz_2010_us_860_00_500k.prj", "r") as prj_file:
...
texas_distance.plot(column="distance_miles", legend=True)
```
